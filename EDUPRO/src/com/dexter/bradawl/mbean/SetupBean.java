...
public class SetupBean implements java.io.Serializable
{
	...
	public void UpdateSchool()
	{
		...
		int ret = new OptionModel().UpdateSchool(appOptions.getSchool());
		if(ret == 0)
		{
		...
		{
			curContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, Utils.getBundleMessage("update.failed", null), null));
		}
		
		appOptions.reloadSchool();
	}
