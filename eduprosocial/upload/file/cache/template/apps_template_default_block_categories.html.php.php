...
<?php if (count((array)$this->_aVars['aCategories'])):  foreach ((array) $this->_aVars['aCategories'] as $this->_aVars['aCategory']): ?>
		<li class="<?php if ($this->_aVars['iCurrentCategory'] == $this->_aVars['aCategory']['category_id']): ?> active<?php endif; ?>">
			<a href="<?php echo $this->_aVars['aCategory']['url']; ?>" class="ajax_link">
