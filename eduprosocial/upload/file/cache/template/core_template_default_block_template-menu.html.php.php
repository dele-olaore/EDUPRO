...
<?php if (count((array)$this->_aVars['aMenus'])):  $this->_aPhpfoxVars['iteration']['menu'] = 0;  foreach ((array) $this->_aVars['aMenus'] as $this->_aVars['iKey'] => $this->_aVars['aMenu']):  $this->_aPhpfoxVars['iteration']['menu']++; ?>
								...
								<li <?php if (( $this->_aVars['aMenu']['url'] == 'apps' && count ( $this->_aVars['aInstalledApps'] ) ) || ( isset ( $this->_aVars['aMenu']['children'] ) && count ( $this->_aVars['aMenu']['children'] ) )): ?>class="explore<?php if (( $this->_aVars['aMenu']['url'] == 'apps' && count ( $this->_aVars['aInstalledApps'] ) )): ?> explore_apps<?php endif; ?>"<?php endif; ?>><a <?php if (! isset ( $this->_aVars['aMenu']['no_link'] ) || $this->_aVars['aMenu']['no_link'] != true): ?>href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aMenu']['url']); ?>" <?php else: ?> href="#" onclick="return false;" <?php endif; ?> class="<?php if (isset ( $this->_aVars['aMenu']['external'] ) && $this->_aVars['aMenu']['external'] == true): ?>no_ajax_link <?php endif; ?>ajax_link">
<?php echo Phpfox::getPhrase($this->_aVars['aMenu']['module'].'.'.$this->_aVars['aMenu']['var_name']);  if (isset ( $this->_aVars['aMenu']['suffix'] )):  echo $this->_aVars['aMenu']['suffix'];  endif; ?></a>
<?php if (isset ( $this->_aVars['aMenu']['children'] ) && count ( $this->_aVars['aMenu']['children'] )): ?>
									<ul>
...
<?php else: ?>
<?php if ($this->_aVars['aMenu']['url'] == 'apps' && count ( $this->_aVars['aInstalledApps'] )): ?>
									<ul>
...
<?php if (count ( $this->_aVars['aAppMenus'] )): ?>
...
<?php endif; ?>
<?php unset($this->_aVars['aAppMenus']); ?>
						</ul>
<?php endif; ?>
