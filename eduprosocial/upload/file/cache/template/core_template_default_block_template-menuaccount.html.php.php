...
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aGlobalUser']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aGlobalUser']['user_name'], ((empty($this->_aVars['aGlobalUser']['user_name']) && isset($this->_aVars['aGlobalUser']['profile_page_id'])) ? $this->_aVars['aGlobalUser']['profile_page_id'] : null))) . '"10>' . Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aGlobalUser']['full_name'], 20, '...') . '</a></span>'; ?>
													</div>
												</li>		
...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aGlobalUser'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
													...
													<div id="header_menu_user_profile">
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aGlobalUser']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aGlobalUser']['user_name'], ((empty($this->_aVars['aGlobalUser']['user_name']) && isset($this->_aVars['aGlobalUser']['profile_page_id'])) ? $this->_aVars['aGlobalUser']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aGlobalUser']['full_name'], 20, '...') . '</a></span>'; ?>
													</div>
												</li>
