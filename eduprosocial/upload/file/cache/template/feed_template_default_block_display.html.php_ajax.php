...
<?php /* Cached: June 3, 2013, 3:18 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php else:  if (! Phpfox ::getService('profile')->timeline()):  /* Cached: June 3, 2013, 3:18 pm */  
/**
 * [PHPFOX_HEADER]
 * 
 * @copyright		[PHPFOX_COPYRIGHT]
...
<?php else: ?>
<?php /* Cached: June 3, 2013, 3:18 pm */  if (isset ( $this->_aVars['bIsViewingComments'] ) && $this->_aVars['bIsViewingComments']): ?>
...
<?php /* Cached: June 3, 2013, 3:18 pm */  if (Phpfox ::getParam('like.show_user_photos')): ?>
