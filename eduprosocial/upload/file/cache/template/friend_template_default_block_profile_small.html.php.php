...
<?php /* Cached: June 3, 2013, 11:17 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aFriend']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aFriend']['user_name'], ((empty($this->_aVars['aFriend']['user_name']) && isset($this->_aVars['aFriend']['profile_page_id'])) ? $this->_aVars['aFriend']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aFriend']['full_name'], 40, '...') . '</a></span>'; ?>
		</div>
		<div class="clear"></div>
	</li>
<?php endforeach; endif; ?>
...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aList'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
			...
			<div class="block_listing_title" style="padding-left:56px;">
<?php echo Phpfox::getLib('phpfox.parse.output')->shorten('<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aList']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aList']['user_name'], ((empty($this->_aVars['aList']['user_name']) && isset($this->_aVars['aList']['profile_page_id'])) ? $this->_aVars['aList']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->split($this->_aVars['aList']['full_name'], 12, true), Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>', 40, '...'); ?>
			</div>
			<div class="clear"></div>
		</li>	
<?php endforeach; endif; ?>
