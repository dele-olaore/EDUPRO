 ...
 */
 ...
 if (! empty ( $this->_aVars['aSearchTool'] ) && is_array ( $this->_aVars['aSearchTool'] )): ?>
	<div class="header_bar_menu">							
<?php if (isset ( $this->_aVars['aSearchTool']['search'] )): ?>
			<div class="header_bar_search">
				<form method="post" action="<?php echo $this->_aVars['aSearchTool']['search']['action']; ?>" onbeforesubmit="$Core.Search.checkDefaultValue(this,'<?php echo $this->_aVars['aSearchTool']['search']['default_value']; ?>');">
...
<?php if (count((array)$this->_aVars['aSearchFilters']['data'])):  foreach ((array) $this->_aVars['aSearchFilters']['data'] as $this->_aVars['aSearchFilter']): ?>
										<li>
											<a href="<?php echo $this->_aVars['aSearchFilter']['link']; ?>" class="ajax_link <?php if (isset ( $this->_aVars['aSearchFilter']['is_active'] )): ?>active<?php endif; ?>"<?php if (isset ( $this->_aVars['aSearchFilters']['width'] )): ?> style="width:<?php echo $this->_aVars['aSearchFilters']['width']; ?>;"<?php endif; ?>>
