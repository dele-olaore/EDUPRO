...
<?php /* Cached: May 28, 2013, 11:44 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
 ...
 */
 ...
 if (count ( $this->_aVars['aLoggedInUsers'] )): ?>
<div class="block_listing_inline">
	<ul>
<?php if (count((array)$this->_aVars['aLoggedInUsers'])):  $this->_aPhpfoxVars['iteration']['loggedusers'] = 0;  foreach ((array) $this->_aVars['aLoggedInUsers'] as $this->_aVars['aLoggedInUser']):  $this->_aPhpfoxVars['iteration']['loggedusers']++; ?>

	<li>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aLoggedInUser'],'suffix' => '_50_square','max_width' => 32,'max_height' => 32,'class' => 'js_hover_title')); ?>
	</li>
<?php endforeach; endif; ?>
	</ul>
	<div class="clear"></div>
