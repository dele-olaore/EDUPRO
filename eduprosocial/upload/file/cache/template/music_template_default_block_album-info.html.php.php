...
<div class="info">
	<div class="info_left">
<?php echo Phpfox::getPhrase('music.rating'); ?>:
	</div>	
...
<div class="info">
	<div class="info_left">
<?php echo Phpfox::getPhrase('music.plays'); ?>:
	</div>
	<div class="info_right">
<?php echo $this->_aVars['aAlbum']['total_play']; ?>
	</div>
</div>
<?php if (! empty ( $this->_aVars['aAlbum']['year'] )): ?>
<div class="info">
	<div class="info_left">
<?php echo Phpfox::getPhrase('music.released'); ?>:
	</div>
	<div class="info_right">
<?php echo $this->_aVars['aAlbum']['year']; ?>
	</div>
</div>
<?php endif; ?>
<div class="info">
	<div class="info_left">
<?php echo Phpfox::getPhrase('music.tracks'); ?>:
	</div>
	<div class="info_right">
<?php echo $this->_aVars['aAlbum']['total_track']; ?>
	</div>
</div>
