...
<?php if (count((array)$this->_aVars['aGenres'])):  foreach ((array) $this->_aVars['aGenres'] as $this->_aVars['aGenre']): ?>
		<li <?php if ($this->_aVars['iCurrentGenre'] == $this->_aVars['aGenre']['genre_id']): ?> class="active"<?php endif; ?>><a href="<?php echo $this->_aVars['aGenre']['link']; ?>" id="music_genre_<?php echo $this->_aVars['aGenre']['genre_id']; ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('locale')->convert($this->_aVars['aGenre']['name'])); ?></a></li>
<?php endforeach; endif; ?>
	</ul>
</div>
