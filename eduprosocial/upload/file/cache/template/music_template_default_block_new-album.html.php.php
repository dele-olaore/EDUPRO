...
<?php /* Cached: June 16, 2013, 2:36 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php if (count((array)$this->_aVars['aNewAlbums'])):  foreach ((array) $this->_aVars['aNewAlbums'] as $this->_aVars['aAlbum']): ?>
	<li>
...
)); ?>"><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => $this->_aVars['aAlbum']['server_id'],'path' => 'music.url_image','file' => $this->_aVars['aAlbum']['image_path'],'suffix' => '_50_square','max_width' => '32','max_height' => '32')); ?></a>
		</div>
		<div class="block_listing_title" style="padding-left:38px;">
			<a href="<?php echo Phpfox::permalink('music.album', $this->_aVars['aAlbum']['album_id'], $this->_aVars['aAlbum']['name'], false, null, (array) array (
)); ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aAlbum']['name']); ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aAlbum']['name']), 30, '...'), 30); ?></a>
			<div class="extra_info">
				<ul class="extra_info_middot"><li><?php if ($this->_aVars['aAlbum']['total_track'] == 1):  echo Phpfox::getPhrase('music.1_track');  else:  echo Phpfox::getPhrase('music.total_tracks', array('total' => number_format($this->_aVars['aAlbum']['total_track'])));  endif; ?></li><li>&middot;</li><li><?php if ($this->_aVars['aAlbum']['total_play'] == 1):  echo Phpfox::getPhrase('music.1_play');  else:  echo Phpfox::getPhrase('music.total_plays', array('total' => number_format($this->_aVars['aAlbum']['total_play'])));  endif; ?></li></ul>
			</div>
		</div>
		<div class="clear"></div>	
	</li>
