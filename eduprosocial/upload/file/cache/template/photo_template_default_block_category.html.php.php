...
<?php /* Cached: May 31, 2013, 4:26 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
 ...
 */
 ...
 if (isset ( $this->_aVars['aCategories'] )):  /* Cached: May 31, 2013, 4:26 am */ 
/**
 * [PHPFOX_HEADER]
 *
 * @copyright		[PHPFOX_COPYRIGHT]
...
<?php else:  if ($this->_aVars['bParent']): ?>
<ul class="action">
	<li><a href="<?php if ($this->_aVars['aCallback'] === null):  echo Phpfox::getLib('phpfox.url')->makeUrl('photo');  else:  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aCallback']['url_home']);  endif; ?>" class="js_photo_category"><?php echo Phpfox::getPhrase('photo.all_categories'); ?></a><?php endif; ?>
<?php echo $this->_aVars['sCategories'];  if ($this->_aVars['bParent']): ?></li>
</ul>
<?php endif;  endif; ?>
