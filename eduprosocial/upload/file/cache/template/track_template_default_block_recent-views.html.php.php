...
<div class="block_listing_inline">
	<ul>
<?php if (count((array)$this->_aVars['aLatestUsers'])):  $this->_aPhpfoxVars['iteration']['latestusers'] = 0;  foreach ((array) $this->_aVars['aLatestUsers'] as $this->_aVars['iLatestUser'] => $this->_aVars['aLatestUser']):  $this->_aPhpfoxVars['iteration']['latestusers']++; ?>

		<li><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aLatestUser'],'suffix' => '_50_square','max_width' => 32,'max_height' => 32,'class' => 'js_hover_title')); ?></li>
<?php endforeach; endif; ?>
	</ul>
	<div class="clear"></div>
</div>
